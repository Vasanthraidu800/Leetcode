<h2><a href="https://leetcode.com/problems/minimum-operations-to-reduce-an-integer-to-0/description/?envType=problem-list-v2&envId=greedy">2710. Minimum Operations to Reduce an Integer to 0</a></h2><h3>Medium</h3><hr><p>You are given a positive integer <code>n</code>, you can do the following operation <strong>any</strong> number of times:</p>
